function calcShipping(sum, min, shipping) {
    ...
    } else if (productsSum > freeShippingMinSum || productsSum === freeShippingMinSum) { // если productsSum Больше или равна freeShippingMinSum,
        console.log (shippingSum = 0); // то shippingSum присвоить значение 0
...
function calcDiscount(sum, min, discount) {
    ...
    if (productsSum >= discountMinSum) { // если productsSum больше или равно discountMinSum,
        ...
        console.log(discountSum = 0); // иначе присвойте discountSum значение 0
    }
...
function calcInvoice({sum, discountMinSum, discountPart, shippingFreeMinSum, shippingPrice}) {
    ...
    console.log(freeShipping); // запишите без использования if или любых других условий: если shippingSum равно нулю, то freeShipping должна быть равна true, иначе freeShipping должна быть равна false
